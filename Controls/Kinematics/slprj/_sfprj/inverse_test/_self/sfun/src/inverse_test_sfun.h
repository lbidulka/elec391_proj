#ifndef __inverse_test_sfun_h__
#define __inverse_test_sfun_h__
...
extern mxArray* load_inverse_test_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_inverse_test_optimization_info(void);
